            ...
            Antropology.find({})
                ...
                .then(researches => {
                    ...
                    if (searchParams) {
                        ...
                        res.render('researches/antropology/index', { researches: result, students: students, groups: groups, way: '/antropology' });
                    }
                    else {
                        res.render('researches/antropology/index', { researches: researches, students: students, groups: groups, way: '/antropology' });
                    }
                })
                .catch(err => {
                    console.log(err);
